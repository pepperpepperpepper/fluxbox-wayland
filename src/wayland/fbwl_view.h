...
struct fbwl_view {
    ...
    struct wlr_scene_buffer *decor_label_tex;
    struct wlr_scene_rect *decor_label;
    ...
    struct wlr_scene_buffer *decor_handle_tex;
    struct wlr_scene_rect *decor_handle;
    struct wlr_scene_buffer *decor_grip_left_tex;
    struct wlr_scene_rect *decor_grip_left;
    struct wlr_scene_buffer *decor_grip_right_tex;
    struct wlr_scene_rect *decor_grip_right;
    struct wlr_scene_buffer *decor_btn_menu_tex;
    struct wlr_scene_rect *decor_btn_menu;
    struct wlr_scene_buffer *decor_btn_menu_icon;
    struct wlr_scene_buffer *decor_btn_shade_tex;
    struct wlr_scene_rect *decor_btn_shade;
    struct wlr_scene_buffer *decor_btn_shade_icon;
    struct wlr_scene_buffer *decor_btn_stick_tex;
    struct wlr_scene_rect *decor_btn_stick;
    struct wlr_scene_buffer *decor_btn_stick_icon;
    struct wlr_scene_buffer *decor_btn_close_tex;
    struct wlr_scene_rect *decor_btn_close;
    struct wlr_scene_buffer *decor_btn_close_icon;
    struct wlr_scene_buffer *decor_btn_max_tex;
    struct wlr_scene_rect *decor_btn_max;
    struct wlr_scene_buffer *decor_btn_max_icon;
    struct wlr_scene_buffer *decor_btn_min_tex;
    struct wlr_scene_rect *decor_btn_min;
    struct wlr_scene_buffer *decor_btn_min_icon;
    struct wlr_scene_buffer *decor_btn_lhalf_tex;
    struct wlr_scene_rect *decor_btn_lhalf;
    struct wlr_scene_buffer *decor_btn_lhalf_icon;
    struct wlr_scene_buffer *decor_btn_rhalf_tex;
    struct wlr_scene_rect *decor_btn_rhalf;
    struct wlr_scene_buffer *decor_btn_rhalf_icon;
